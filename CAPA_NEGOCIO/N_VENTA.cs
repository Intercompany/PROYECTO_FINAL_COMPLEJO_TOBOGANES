...
namespace CAPA_NEGOCIO
{
    public class N_VENTA
    {
        ...
        public string MANTENIMIENTO_VENTA(E_VENTA_Y_DETALLE OBJ_VENTA)
        {
           return OBJTIPO_BIEN.MANTENIMIENTO_VENTA(OBJ_VENTA);
        }
        public string MANTENIMIENTO_VENTADETALLE(E_VENTA_Y_DETALLE OBJ_VENTADETALLE)
        {
            return OBJTIPO_BIEN.MANTENIMIENTO_VENTADETALLE(OBJ_VENTADETALLE);
        }
        ...
        public string CAJA_KARDEX_MANTENIMIENTO(E_CAJA_KARDEX OBJMANT_CAJA_KARDEX)
        {
            return OBJTIPO_BIEN.CAJA_KARDEX_MANTENIMIENTO(OBJMANT_CAJA_KARDEX);
        }
