...
{
    public partial class KIOSKOBEBIDAS : Form
    {
        ...
        public KIOSKOBEBIDAS()
        {
            InitializeComponent();
        }
        private void KIOSKOBEBIDAS_Load(object sender, EventArgs e)
        {
            this.SetStyle(ControlStyles.DoubleBuffer | ControlStyles.AllPaintingInWmPaint, true);
            this.SetStyle(ControlStyles.UserPaint, true);

            lblTicket.Text = Convert.ToString(Convert.ToDouble(Properties.Settings.Default.numero_vr) +1);
        ...
        void LLENAR_CLASE_BIEN()
        {
            ...
            if ((Properties.Settings.Default.punto_venta == "PV015"))
        ...
        public void ShowMyDialogBox()
        {
            ...
            try
            {
                testDialog.txtCLIENTE_VENTA.AutoCompleteMode = AutoCompleteMode.Suggest;
                testDialog.txtCLIENTE_VENTA.AutoCompleteSource = AutoCompleteSource.CustomSource;
                ...
                dr.Close();
                testDialog.txtCLIENTE_VENTA.AutoCompleteCustomSource = col;
                con.Close();
                con.Open();
                if (testDialog.txtCLIENTE_VENTA.Text.Length >= 6)
                {
                    SqlCommand cmv = new SqlCommand("SELECT ID_CLIENTE,RUC_DNI,DIRECCION,DESCRIPCION FROM CLIENTE where DESCRIPCION = '" + testDialog.txtCLIENTE_VENTA.Text + "'", con);
                    DataTable dt = new DataTable();
                    SqlDataAdapter da = new SqlDataAdapter(cmv);
                    da.Fill(dt);
                    testDialog.txtCLIENTE_ID.Text = dt.Rows[0][0].ToString();
                    testDialog.txtCLIENTE_RUC.Text = dt.Rows[0][1].ToString();
                    testDialog.txtCLIENTE_VENTA.Text = dt.Rows[0][3].ToString();
                    Properties.Settings.Default.direccion_vr = dt.Rows[0][2].ToString();
                    con.Close();
                }
                else { con.Close(); }
            }
        ...
        void P_IMPRIMIR()
        {
            ...
            Properties.Settings.Default.numero_vr = dt.Rows[0][1].ToString();
            ...
            */
            ...
            for (int f = 0; f < dgvBIEN_VENTA.Rows.Count; f++)
            {
                if (DATOS_VENTADETALLE.Rows[f]["B_EMITE_TICKET"].Equals(true))
                {
                    ...
                    Ticket1.LineasGuion();
                    Ticket1.TextoCentro("");
                    Ticket1.TextoCentro("" + Convert.ToString(Convert.ToInt32(DATOS_VENTADETALLE.Rows[f]["VD_CANTIDAD"].ToString())) + "");
        ...
        private void btnBIEN13_Click_1(object sender, EventArgs e)
        {
            if (idbien[12] != null)
            {
                OBTENER_ID_BIEN_Y_LLENAR_GRILLA(idbien[12].ToString(), valor[12].ToString(), PRECIO_BIEN[12].ToString());
        ...
        private void btnBIEN14_Click_1(object sender, EventArgs e)
        {
            if (idbien[13] != null)
            {
                OBTENER_ID_BIEN_Y_LLENAR_GRILLA(idbien[13].ToString(), valor[13].ToString(), PRECIO_BIEN[13].ToString());
        ...
        private void btnBIEN15_Click_1(object sender, EventArgs e)
        {
            if (idbien[14] != null)
            {
                OBTENER_ID_BIEN_Y_LLENAR_GRILLA(idbien[14].ToString(), valor[14].ToString(), PRECIO_BIEN[14].ToString());
        ...
        private void btnBIEN16_Click_1(object sender, EventArgs e)
        {
            if (idbien[15] != null)
            {
                OBTENER_ID_BIEN_Y_LLENAR_GRILLA(idbien[15].ToString(), valor[15].ToString(), PRECIO_BIEN[15].ToString());
        ...
        private void txtCANTIDAD_VENTA_Click(object sender, EventArgs e)
        {
        ...
        private void btnBIEN17_Click_1(object sender, EventArgs e)
        {
            if (idbien[16] != null)
            {
        ...
        private void btnBIEN18_Click_1(object sender, EventArgs e)
        {
            if (idbien[17] != null)
            {
        ...
        private void btnBIEN19_Click_1(object sender, EventArgs e)
        {
            if (idbien[18] != null)
            {
        ...
        private void btnBIEN20_Click_1(object sender, EventArgs e)
        {
            if (idbien[19] != null)
            {
